...
abstract class AbstractRector extends NodeVisitorAbstract implements PhpRectorInterface
{
     ...
     * @required
     */
    public function autowireAbstractRector(SymfonyStyle $symfonyStyle, PhpVersionProvider $phpVersionProvider, BuilderFactory $builderFactory, ExclusionManager $exclusionManager, DocBlockManipulator $docBlockManipulator, StaticTypeMapper $staticTypeMapper, ParameterProvider $parameterProvider, CurrentRectorProvider $currentRectorProvider, ClassNodeAnalyzer $classNodeAnalyzer, CurrentNodeProvider $currentNodeProvider, Skipper $skipper): void
    {
