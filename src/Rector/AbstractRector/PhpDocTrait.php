...
trait PhpDocTrait
{
     ...
     * @required
     */
    public function autowirePhpDocTrait(PhpDocInfoPrinter $phpDocInfoPrinter, PhpDocInfoFactory $phpDocInfoFactory, PhpDocInfoManipulator $phpDocInfoManipulator): void
    {
