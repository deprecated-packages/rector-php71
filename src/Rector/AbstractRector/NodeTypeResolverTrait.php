...
trait NodeTypeResolverTrait
{
     ...
     * @required
     */
    public function autowireNodeTypeResolverTrait(NodeTypeResolver $nodeTypeResolver, ArrayTypeAnalyzer $arrayTypeAnalyzer, CountableTypeAnalyzer $countableTypeAnalyzer, StringTypeAnalyzer $stringTypeAnalyzer, TypeUnwrapper $typeUnwrapper): void
    {
