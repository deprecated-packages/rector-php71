...
trait RemovedAndAddedFilesTrait
{
     ...
     * @required
     */
    public function autowireRemovedAndAddedFilesTrait(RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, RenamedClassesCollector $renamedClassesCollector): void
    {
