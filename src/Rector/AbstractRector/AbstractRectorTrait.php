...
trait AbstractRectorTrait
{
     ...
     * @required
     */
    public function autowireAbstractRectorTrait(BetterStandardPrinter $betterStandardPrinter, NodeNameResolver $nodeNameResolver, ClassNaming $classNaming, NodeTypeResolver $nodeTypeResolver, TypeUnwrapper $typeUnwrapper, SimpleCallableNodeTraverser $simpleCallableNodeTraverser): void
    {
