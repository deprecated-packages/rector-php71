...
final class RectorKernel extends Kernel implements ExtraConfigAwareKernelInterface
{
    ...
    protected function build(ContainerBuilder $containerBuilder): void
    {
        ...
        $containerBuilder->addCompilerPass(new MergeImportedRectorConfigureCallValuesCompilerPass($this->configureCallValuesCollector));
    }
    ...
    protected function getContainerLoader(ContainerInterface $container): DelegatingLoader
    {
        ...
        $loaderResolver = new LoaderResolver([
            ...
            new ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector),
        ]);
