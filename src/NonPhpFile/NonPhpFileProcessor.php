...
final class NonPhpFileProcessor
{
    ...
    public function __construct(RenamedClassesDataCollector $renamedClassesDataCollector, Configuration $configuration, RenamedClassesCollector $renamedClassesCollector, SmartFileSystem $smartFileSystem, NonPhpFileClassRenamer $nonPhpFileClassRenamer, ErrorAndDiffCollector $errorAndDiffCollector)
    {
