...
final class NonPhpFileProcessor
{
    ...
    public function __construct(RenamedClassesDataCollector $renamedClassesDataCollector, Configuration $configuration, RenamedClassesCollector $renamedClassesCollector, SmartFileSystem $smartFileSystem, SymfonyStyle $symfonyStyle, NonPhpFileClassRenamer $nonPhpFileClassRenamer)
    {
