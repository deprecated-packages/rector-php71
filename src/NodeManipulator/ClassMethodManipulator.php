...
final class ClassMethodManipulator
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, FuncCallManipulator $funcCallManipulator, NodeNameResolver $nodeNameResolver, NodeTypeResolver $nodeTypeResolver, NodeComparator $nodeComparator)
    {
