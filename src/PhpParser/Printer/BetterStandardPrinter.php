...
final class BetterStandardPrinter extends Standard
{
     ...
     * @param mixed[] $options
     */
    public function __construct(CommentRemover $commentRemover, IndentCharacterDetector $indentCharacterDetector, DocBlockUpdater $docBlockUpdater, array $options = [])
    {
