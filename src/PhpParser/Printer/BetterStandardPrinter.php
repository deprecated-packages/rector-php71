...
final class BetterStandardPrinter extends Standard
{
    ...
    public function printFormatPreserving(array $stmts, array $origStmts, array $origTokens): string
    {
        ...
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_STRING_REGEX, ContentPatcher::INVALID_ANNOTATION_STRING_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_ROUTE_REGEX, ContentPatcher::INVALID_ANNOTATION_ROUTE_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_COMMENT_REGEX, ContentPatcher::INVALID_ANNOTATION_COMMENT_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_CONSTRAINT_REGEX, ContentPatcher::INVALID_ANNOTATION_CONSTRAINT_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_ROUTE_OPTION_REGEX, ContentPatcher::INVALID_ANNOTATION_ROUTE_OPTION_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_ROUTE_LOCALIZATION_REGEX, ContentPatcher::INVALID_ANNOTATION_ROUTE_LOCALIZATION_REGEX);
        $content = $this->contentPatcher->rollbackValidAnnotation($contentOriginal, $content, ContentPatcher::VALID_ANNOTATION_VAR_RETURN_EXPLICIT_FORMAT_REGEX, ContentPatcher::INVALID_ANNOTATION_VAR_RETURN_EXPLICIT_FORMAT_REGEX);
