...
final class BetterNodeFinder
{
    ...
    public function __construct(BetterStandardPrinter $betterStandardPrinter, NodeFinder $nodeFinder, NodeNameResolver $nodeNameResolver, TypeChecker $typeChecker)
    {
