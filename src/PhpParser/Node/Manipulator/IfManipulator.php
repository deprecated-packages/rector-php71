...
final class IfManipulator
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, BetterStandardPrinter $betterStandardPrinter, ConstFetchManipulator $constFetchManipulator, NodeNameResolver $nodeNameResolver, StmtsManipulator $stmtsManipulator)
    {
