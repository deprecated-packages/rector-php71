...
final class ClassMethodManipulator
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, BetterStandardPrinter $betterStandardPrinter, FuncCallManipulator $funcCallManipulator, NodeNameResolver $nodeNameResolver, NodeTypeResolver $nodeTypeResolver)
    {
    ...
    {
        $isUsedDirectly = (bool) $this->betterNodeFinder->findFirst((array) $classMethod->stmts, function (Node $node) use ($param): bool {
