...
final class PropertyManipulator
{
    ...
    public function __construct(AssignManipulator $assignManipulator, BetterNodeFinder $betterNodeFinder, BetterStandardPrinter $betterStandardPrinter, NodeNameResolver $nodeNameResolver, VariableToConstantGuard $variableToConstantGuard, NodeRepository $nodeRepository, ReadWritePropertyAnalyzer $readWritePropertyAnalyzer)
    {
    ...
    public function getPrivatePropertyFetches(Property $property): array
    {
        ...
        $propertyFetches = $this->betterNodeFinder->find($nodesToSearch, function (Node $node) use ($singleProperty, $nodesToSearch): bool {
