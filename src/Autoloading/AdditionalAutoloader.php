...
final class AdditionalAutoloader
{
    ...
    public function __construct(FileGuard $fileGuard, FileSystemFilter $fileSystemFilter, ParameterProvider $parameterProvider, SkippedPathsResolver $skippedPathsResolver)
    {
