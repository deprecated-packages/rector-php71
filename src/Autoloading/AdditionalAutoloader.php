...
final class AdditionalAutoloader
{
    ...
    public function __construct(FileSystemFilter $fileSystemFilter, ParameterProvider $parameterProvider, SkippedPathsResolver $skippedPathsResolver, FileSystemGuard $fileSystemGuard)
    {
