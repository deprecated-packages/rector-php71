...
final class StringExprResolver
{
    ...
    public function __construct(ConstantNodeFactory $constantNodeFactory, CommonNodeFactory $commonNodeFactory, SymfonyFunctionNameProvider $symfonyFunctionNameProvider)
    {
