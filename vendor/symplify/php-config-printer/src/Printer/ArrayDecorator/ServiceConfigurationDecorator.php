...
final class ServiceConfigurationDecorator
{
    ...
    public function __construct(ConstantNameFromValueResolver $constantNameFromValueResolver, NewValueObjectFactory $newValueObjectFactory)
    {
     ...
     * @param object $value
     */
    private function decorateValueObject($value): StaticCall
    {
