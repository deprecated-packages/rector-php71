...
final class ArgsNodeFactory
{
    ...
    public function __construct(CommonNodeFactory $commonNodeFactory, ConstantNodeFactory $constantNodeFactory, SymfonyVersionFeatureGuardInterface $symfonyVersionFeatureGuard)
    {
    ...
    private function resolveStringExpr(string $value, bool $skipServiceReference, bool $skipClassesToConstantReference): Expr
    {
        if ($value === '') {
