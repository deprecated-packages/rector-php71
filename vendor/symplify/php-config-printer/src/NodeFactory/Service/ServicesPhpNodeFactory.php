...
final class ServicesPhpNodeFactory
{
    ...
    public function __construct(CommonNodeFactory $commonNodeFactory, ArgsNodeFactory $argsNodeFactory, AutoBindNodeFactory $autoBindNodeFactory)
    {
    ...
    public function createResource(string $serviceKey, array $serviceValues): Expression
    {
        ...
        $servicesLoadMethodCall = $this->autoBindNodeFactory->createAutoBindCalls($serviceValues, $servicesLoadMethodCall, AutoBindNodeFactory::TYPE_SERVICE);
