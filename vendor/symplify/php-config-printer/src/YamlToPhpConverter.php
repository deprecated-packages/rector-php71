...
final class YamlToPhpConverter
{
    ...
    public function __construct(Parser $yamlParser, PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, ContainerConfiguratorReturnClosureFactory $returnClosureNodesFactory, RoutingConfiguratorReturnClosureFactory $routingConfiguratorReturnClosureFactory, YamlFileContentProviderInterface $yamlFileContentProvider, CheckerServiceParametersShifter $checkerServiceParametersShifter)
    {
