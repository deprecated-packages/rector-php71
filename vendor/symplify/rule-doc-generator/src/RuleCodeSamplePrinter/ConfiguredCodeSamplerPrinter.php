...
final class ConfiguredCodeSamplerPrinter
{
    ...
    public function __construct(SmartPhpConfigPrinter $smartPhpConfigPrinter, MarkdownCodeWrapper $markdownCodeWrapper, DiffCodeSamplePrinter $diffCodeSamplePrinter)
    {
     ...
     * @return string[]
     */
    public function printConfiguredCodeSample(RuleDefinition $ruleDefinition, ConfiguredCodeSample $configuredCodeSample): array
    {
        $lines = [];
