...
final class RectorRuleCodeSamplePrinter implements RuleCodeSamplePrinterInterface
{
    ...
    public function __construct(DiffCodeSamplePrinter $diffCodeSamplePrinter, MarkdownCodeWrapper $markdownCodeWrapper, ConfiguredCodeSamplerPrinter $configuredCodeSamplerPrinter)
    {
