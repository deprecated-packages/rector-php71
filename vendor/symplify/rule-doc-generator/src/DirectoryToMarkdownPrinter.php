...
final class DirectoryToMarkdownPrinter
{
    ...
    public function __construct(ClassByTypeFinder $classByTypeFinder, SymfonyStyle $symfonyStyle, RuleDefinitionsResolver $ruleDefinitionsResolver, RuleDefinitionsPrinter $ruleDefinitionsPrinter)
    {
    ...
    public function print(string $workingDirectory, array $directories, bool $shouldCategorize = false): string
    {
        ...
        $classes = array_map(function (RuleClassWithFilePath $rule): string {
