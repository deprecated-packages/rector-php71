...
final class AnnotateThrowablesRector extends AbstractRector
{
    ...
    public function __construct(ClassMethodReflectionHelper $classMethodReflectionHelper, ClassResolver $classResolver, FunctionAnnotationResolver $functionAnnotationResolver, ThrowAnalyzer $throwAnalyzer, ThrowsFactory $throwsFactory)
    {
    ...
    {
        return new RuleDefinition('Adds @throws DocBlock comments to methods that thrwo \Throwables.', [
            new CodeSample(
                // code before
                <<<'CODE_SAMPLE'
