...
final class ShortNameResolver
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, CurrentFileInfoProvider $currentFileInfoProvider, PhpDocInfoFactory $phpDocInfoFactory, ClassNaming $classNaming)
    {
    ...
    public function resolveShortClassLikeNamesForNode(Node $node): array
    {
        ...
        $shortClassLikeNames = [];
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($namespace, function (Node $node) use (&$shortClassLikeNames) {
            // ...
    ...
    {
        $shortNames = [];
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($stmts, function (Node $node) use (&$shortNames): void {
            // class name is used!
