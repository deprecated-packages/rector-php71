...
final class ChangeQueryWhereDateValueWithCarbonRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Add parent::boot(); call to boot() class method in child of Illuminate\Database\Eloquent\Model', [
...
CODE_SAMPLE
    ...
    {
        if (! $this->isOnClassMethodCall($methodCall, new ObjectType('Illuminate\Database\Query\Builder'), 'whereDate')) {
            return null;
        }
