...
final class GenericsPHPStormMethodAnnotationRector extends AbstractRector
{
    ...
    public function __construct(ClassGenericMethodResolver $classGenericMethodResolver, GenericTypeSpecifier $genericTypeSpecifier, GenericClassReflectionAnalyzer $genericClassReflectionAnalyzer)
    {
