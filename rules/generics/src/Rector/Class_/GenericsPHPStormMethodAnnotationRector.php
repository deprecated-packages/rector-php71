...
final class GenericsPHPStormMethodAnnotationRector extends AbstractRector
{
    ...
    public function __construct(ClassGenericMethodResolver $classGenericMethodResolver, GenericTypeSpecifier $genericTypeSpecifier, GenericClassReflectionAnalyzer $genericClassReflectionAnalyzer, ClassMethodAnalyzer $classMethodAnalyzer)
    {
...
CODE_SAMPLE
     ...
     */
    private function filterOutExistingClassMethod(array $methodTagValueNodes, PhpDocInfo $phpDocInfo, GenericChildParentClassReflections $genericChildParentClassReflections, Scope $scope): array
    {
