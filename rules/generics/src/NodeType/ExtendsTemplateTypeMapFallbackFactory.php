...
final class ExtendsTemplateTypeMapFallbackFactory
{
    ...
    {
        return new TemplateObjectType($templateTypeScope, new TemplateTypeParameterStrategy(), TemplateTypeVariance::createInvariant(), $parentGenericTypeName, $typeWithClassName->getClassName());
    }
}
