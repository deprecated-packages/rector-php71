...
final class ReturnTypeDeclarationUpdater
{
    ...
    public function __construct(NodeNameResolver $nodeNameResolver, PhpDocInfoManipulator $phpDocInfoManipulator, PhpVersionProvider $phpVersionProvider, StaticTypeMapper $staticTypeMapper)
    {
    ...
    private function updatePhpDoc(ClassMethod $classMethod, string $className): void
    {
        ...
        $returnTagValueNode = $this->phpDocInfoManipulator->getPhpDocTagValueNode($classMethod, ReturnTagValueNode::class);
