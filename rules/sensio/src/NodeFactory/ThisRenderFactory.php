...
final class ThisRenderFactory
{
    ...
    public function create(ClassMethod $classMethod, ?Return_ $return, SensioTemplateTagValueNode $sensioTemplateTagValueNode): MethodCall
    {
     ...
     * @return Arg[]
     */
    private function resolveRenderArguments(ClassMethod $classMethod, ?Return_ $return, SensioTemplateTagValueNode $sensioTemplateTagValueNode): array
    {
    ...
    private function resolveTemplateName(ClassMethod $classMethod, SensioTemplateTagValueNode $sensioTemplateTagValueNode): string
    {
    ...
    private function resolveParametersExpr(?Return_ $return, SensioTemplateTagValueNode $sensioTemplateTagValueNode): ?Expr
    {
