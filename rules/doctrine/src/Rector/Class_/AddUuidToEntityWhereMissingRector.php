...
final class AddUuidToEntityWhereMissingRector extends AbstractRector
{
    ...
    public function __construct(EntityUuidNodeFactory $entityUuidNodeFactory, EntityWithMissingUuidProvider $entityWithMissingUuidProvider, UuidMigrationDataCollector $uuidMigrationDataCollector)
    {
