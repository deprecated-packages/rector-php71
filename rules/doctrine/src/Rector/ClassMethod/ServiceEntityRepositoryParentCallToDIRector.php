...
final class ServiceEntityRepositoryParentCallToDIRector extends AbstractRector
{
    ...
    public function __construct(RepositoryNodeFactory $repositoryNodeFactory, RepositoryTypeFactory $repositoryTypeFactory, PropertyToAddCollector $propertyToAddCollector)
    {
    ...
    {
        return new RuleDefinition('Change ServiceEntityRepository to dependency injection, with repository property', [
