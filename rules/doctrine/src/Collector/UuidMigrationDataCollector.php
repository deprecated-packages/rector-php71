...
final class UuidMigrationDataCollector
{
    ...
    public function addClassToManyRelationProperty(string $class, string $oldPropertyName, string $uuidPropertyName, DoctrineRelationTagValueNodeInterface $doctrineRelationTagValueNode): void
    {
