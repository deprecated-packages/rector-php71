...
final class EntityWithMissingUuidProvider
{
    ...
    public function __construct(DoctrineDocBlockResolver $doctrineDocBlockResolver, NodeNameResolver $nodeNameResolver, PhpDocInfoFactory $phpDocInfoFactory, NodeRepository $nodeRepository)
    {
