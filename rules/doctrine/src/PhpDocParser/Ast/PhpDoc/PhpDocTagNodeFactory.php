...
final class PhpDocTagNodeFactory
{
    ...
    public function __construct(JoinTableNameResolver $joinTableNameResolver, ColumnTagValueNodeFactory $columnTagValueNodeFactory, ArrayPartPhpDocTagPrinter $arrayPartPhpDocTagPrinter, TagValueNodePrinter $tagValueNodePrinter, JoinColumnTagValueNodeFactory $joinColumnTagValueNodeFactory)
    {
    ...
    public function createJoinTableTagNode(Property $property): PhpDocTagNode
    {
        ...
        $joinTableTagValueNode = new JoinTableTagValueNode($this->arrayPartPhpDocTagPrinter, $this->tagValueNodePrinter, $uuidJoinTable, null, $uuidJoinColumnTagValueNodes, $uuidJoinColumnTagValueNodes, '', new AroundSpaces('', ''), new AroundSpaces('', ''));
