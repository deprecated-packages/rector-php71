...
final class PhpDocTagNodeFactory
{
    ...
    public function createJoinTableTagNode(Property $property): PhpDocTagNode
    {
        ...
        $joinTableTagValueNode = new JoinTableTagValueNode($uuidJoinTable, null, $uuidJoinColumnTagValueNodes, $uuidJoinColumnTagValueNodes, '', new AroundSpaces('', ''), new AroundSpaces('', ''));
