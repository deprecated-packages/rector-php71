...
final class EventInfosFactory
{
    ...
    {
        $eventInfos = [];
        $eventInfos[] = new EventInfo(['nette.application.startup', 'nette.application.request'], [
        ...
        ], 'Symfony\Component\HttpKernel\KernelEvents', 'REQUEST', 'Symfony\Component\HttpKernel\Event\GetResponseEvent');
        ...
        $eventInfos[] = new EventInfo(['nette.application.presenter', 'nette.application.presenter.startup'], [
        ...
        ], 'Symfony\Component\HttpKernel\KernelEvents', 'CONTROLLER', 'Symfony\Component\HttpKernel\Event\FilterControllerEvent');

        $eventInfos[] = new EventInfo(['nette.application.error'], [
        ...
        ], 'Symfony\Component\HttpKernel\KernelEvents', 'EXCEPTION', 'Symfony\Component\HttpKernel\Event\GetResponseForExceptionEvent');

        $eventInfos[] = new EventInfo(['nette.application.response'], [
        ...
        ], 'Symfony\Component\HttpKernel\KernelEvents', 'RESPONSE', 'Symfony\Component\HttpKernel\Event\FilterResponseEvent');
