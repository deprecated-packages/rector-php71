...
final class RouterListToControllerAnnotationsRector extends AbstractRector
{
    ...
    public function __construct(ExplicitRouteAnnotationDecorator $explicitRouteAnnotationDecorator, ReturnTypeInferer $returnTypeInferer, RouteInfoFactory $routeInfoFactory)
    {
    ...
    {
        return new RuleDefinition('Change new Route() from RouteFactory to @Route annotation above controller method', [
