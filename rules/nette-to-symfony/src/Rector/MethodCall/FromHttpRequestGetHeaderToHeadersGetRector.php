...
final class FromHttpRequestGetHeaderToHeadersGetRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Changes getHeader() to $request->headers->get()', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $requestName = $this->classMethodManipulator->addMethodParameterIfMissing($node, Request::class, ['request', 'symfonyRequest']);
