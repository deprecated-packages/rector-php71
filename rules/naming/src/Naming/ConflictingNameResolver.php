...
final class ConflictingNameResolver
{
    ...
    public function __construct(ArrayFilter $arrayFilter, BetterNodeFinder $betterNodeFinder, ExpectedNameResolver $expectedNameResolver, NodeNameResolver $nodeNameResolver, MatchParamTypeExpectedNameResolver $matchParamTypeExpectedNameResolver)
    {
