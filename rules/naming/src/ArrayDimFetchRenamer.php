...
final class ArrayDimFetchRenamer
{
    ...
    public function __construct(CallableNodeTraverser $callableNodeTraverser, BetterStandardPrinter $betterStandardPrinter)
    {
    ...
    {
        $this->callableNodeTraverser->traverseNodesWithCallable((array) $classMethod->stmts, function (Node $node) use ($arrayDimFetch, $variableName) {
