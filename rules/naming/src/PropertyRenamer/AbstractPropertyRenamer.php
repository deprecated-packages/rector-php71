...
abstract class AbstractPropertyRenamer implements RenamerInterface
{
     ...
     * @required
     */
    public function autowireAbstractPropertyRenamer(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, NodeNameResolver $nodeNameResolver, NotPrivatePropertyGuard $notPrivatePropertyGuard, RamseyUuidInterfaceGuard $ramseyUuidInterfaceGuard, DateTimeAtNamingConventionGuard $dateTimeAtNamingConventionGuard, PropertyRenameGuard $propertyRenameGuard, HasMagicGetSetGuard $hasMagicGetSetGuard, PropertyFetchRenamer $propertyFetchRenamer): void
    {
