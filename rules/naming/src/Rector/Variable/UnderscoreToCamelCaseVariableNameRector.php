...
final class UnderscoreToCamelCaseVariableNameRector extends AbstractRector
{
    ...
    public function __construct(ReservedKeywordAnalyzer $reservedKeywordAnalyzer, ParamRenameFactory $paramRenameFactory, ParamRenamer $underscoreCamelCaseParamRenamer, UnderscoreCamelCaseExpectedNameResolver $underscoreCamelCaseExpectedNameResolver)
    {
