...
final class UnderscoreToCamelCasePropertyNameRector extends AbstractRector
{
    ...
    public function __construct(UnderscoreCamelCasePropertyRenamer $underscoreCamelCasePropertyRenamer, PropertyRenameFactory $propertyRenameFactory, UnderscoreCamelCaseExpectedNameResolver $underscoreCamelCaseExpectedNameResolver)
    {
