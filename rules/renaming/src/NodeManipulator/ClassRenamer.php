...
final class ClassRenamer
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, CallableNodeTraverser $callableNodeTraverser, ClassNaming $classNaming, DocBlockManipulator $docBlockManipulator, NodeNameResolver $nodeNameResolver, PhpDocClassRenamer $phpDocClassRenamer)
    {
