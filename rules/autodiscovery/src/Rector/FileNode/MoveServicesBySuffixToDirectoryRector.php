...
final class MoveServicesBySuffixToDirectoryRector extends AbstractRector implements ConfigurableRectorInterface
{
    ...
    public function __construct(ExpectedFileLocationResolver $expectedFileLocationResolver, MovedFileWithNodesFactory $movedFileWithNodesFactory)
    {
...
, [
     ...
     */
    private function processGroupNamesBySuffix(SmartFileInfo $smartFileInfo, FileNode $fileNode, array $groupNamesBySuffix): void
    {
    ...
    private function isLocatedInExpectedLocation(string $groupName, string $suffixPattern, SmartFileInfo $smartFileInfo): bool
    {
