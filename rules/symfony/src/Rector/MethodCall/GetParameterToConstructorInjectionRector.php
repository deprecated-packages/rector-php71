...
final class GetParameterToConstructorInjectionRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Turns fetching of parameters via `getParameter()` in ContainerAware to constructor injection in Command and Controller in Symfony', [
...
CODE_SAMPLE
    ...
    {
        if (! $this->isObjectType($node->var, new ObjectType('Symfony\Bundle\FrameworkBundle\Controller\Controller'))) {
            return null;
        }
