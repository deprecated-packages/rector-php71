...
final class GetToConstructorInjectionRector extends AbstractToConstructorInjectionRector implements ConfigurableRectorInterface
{
    ...
    public function __construct()
    {
        ...
        $this->getMethodAwareObjectTypes[] = new ObjectType('Symfony\Bundle\FrameworkBundle\Controller\ControllerTrait');
    }

    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('Turns fetching of dependencies via `$this->get()` to constructor injection in Command and Controller in Symfony', [
