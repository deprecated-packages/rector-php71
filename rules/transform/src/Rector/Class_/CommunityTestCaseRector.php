...
final class CommunityTestCaseRector extends AbstractRector
{
    ...
    public function __construct(ProvideConfigFilePathClassMethodFactory $provideConfigFilePathClassMethodFactory, PhpConfigPrinterFactory $phpConfigPrinterFactory)
    {
