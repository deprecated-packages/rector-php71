...
final class OnContainerGetCallManipulator
{
    ...
    {
        $this->callableNodeTraverser->traverseNodesWithCallable($class->stmts, function (Node $node) use ($skipSetUpMethod): ?PropertyFetch {
