...
final class OnContainerGetCallManipulator
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, KernelTestCaseNodeAnalyzer $kernelTestCaseNodeAnalyzer, NodeNameResolver $nodeNameResolver, NodesToRemoveCollector $nodesToRemoveCollector, ServiceNaming $serviceNaming, ValueResolver $valueResolver, FormerVariablesByMethodCollector $formerVariablesByMethodCollector)
    {
    ...
    {
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($class->stmts, function (Node $node): ?PropertyFetch {
    ...
    {
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($class->stmts, function (Node $node) use ($skipSetUpMethod): ?PropertyFetch {
