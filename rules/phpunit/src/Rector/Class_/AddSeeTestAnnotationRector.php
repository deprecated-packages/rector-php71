...
final class AddSeeTestAnnotationRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Add @see annotation test of the class for faster jump to test. Make it FQN, so it stays in the annotation, not in the PHP source code.', [
