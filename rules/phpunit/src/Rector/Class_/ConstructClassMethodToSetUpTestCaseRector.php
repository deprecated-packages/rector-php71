...
final class ConstructClassMethodToSetUpTestCaseRector extends AbstractRector
{
    ...
    public function __construct(SetUpClassMethodNodeManipulator $setUpClassMethodNodeManipulator, StaticCallAnalyzer $staticCallAnalyzer, TestsNodeAnalyzer $testsNodeAnalyzer)
    {
    ...
    {
        return new RuleDefinition('Change __construct() method in tests of `PHPUnit\Framework\TestCase` to setUp(), to prevent dangerous override', [
