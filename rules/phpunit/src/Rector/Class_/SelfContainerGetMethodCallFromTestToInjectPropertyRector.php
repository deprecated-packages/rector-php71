...
final class SelfContainerGetMethodCallFromTestToInjectPropertyRector extends AbstractPHPUnitRector
{
    ...
    public function __construct(ClassManipulator $classManipulator, KernelTestCaseNodeFactory $kernelTestCaseNodeFactory, OnContainerGetCallManipulator $onContainerGetCallManipulator, SelfContainerMethodCallCollector $selfContainerMethodCallCollector, FormerVariablesByMethodCollector $formerVariablesByMethodCollector)
    {
    ...
    {
        return new RuleDefinition('Change $container->get() calls in PHPUnit to @inject properties autowired by jakzal/phpunit-injector', [
