...
final class RestoreFullyQualifiedNameRector extends AbstractRector
{
    ...
    public function __construct(FullyQualifiedNameMatcher $fullyQualifiedNameMatcher, PhpDocTypeNodeNameMatcher $phpDocTypeNodeNameMatcher)
    {
    ...
    {
        return new RuleDefinition('Restore accidentally shortened class names to its fully qualified form.', [
