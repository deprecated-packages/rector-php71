...
final class RemoveUselessJustForSakeInterfaceRector extends AbstractRector
{
    ...
    public function __construct(RenamedClassesCollector $renamedClassesCollector, string $interfacePattern = '#(.*?)#')
    {
    ...
    {
        return new RuleDefinition('Remove interface, that are added just for its sake, but nowhere useful', [
