...
final class FluentChainMethodCallRootExtractor
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, NodeNameResolver $nodeNameResolver, PropertyNaming $propertyNaming, VariableNaming $variableNaming, ExprStringTypeResolver $exprStringTypeResolver, NodeTypeResolver $nodeTypeResolver)
    {
    ...
    private function matchMethodCallOnNew(MethodCall $methodCall): ?AssignAndRootExpr
    {
        ...
        $previousAssignOrReturn = $this->betterNodeFinder->findFirstPreviousOfTypes($methodCall->var, [Assign::class, Return_::class]);
