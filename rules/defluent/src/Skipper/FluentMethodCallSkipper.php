...
final class FluentMethodCallSkipper
{
    ...
    public function __construct(FluentCallStaticTypeResolver $fluentCallStaticTypeResolver, SameClassMethodCallAnalyzer $sameClassMethodCallAnalyzer, FluentChainMethodCallNodeAnalyzer $fluentChainMethodCallNodeAnalyzer, GetterMethodCallAnalyzer $getterMethodCallAnalyzer, StringMatcher $stringMatcher)
    {
