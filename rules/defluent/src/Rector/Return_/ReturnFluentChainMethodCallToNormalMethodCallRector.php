...
final class ReturnFluentChainMethodCallToNormalMethodCallRector extends AbstractFluentChainMethodCallRector
{
    ...
    public function __construct(ReturnFluentMethodCallFactory $returnFluentMethodCallFactory, FluentMethodCallsFactory $fluentMethodCallsFactory, SeparateReturnMethodCallFactory $separateReturnMethodCallFactory)
    {
