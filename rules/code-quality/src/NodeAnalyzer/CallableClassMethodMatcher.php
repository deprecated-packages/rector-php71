...
final class CallableClassMethodMatcher
{
    ...
    public function __construct(ValueResolver $valueResolver, NodeTypeResolver $nodeTypeResolver, NodeRepository $nodeRepository, NodeNameResolver $nodeNameResolver)
    {
