...
final class LocalPropertyAnalyzer
{
    ...
    public function resolveFetchedPropertiesToTypesFromClass(Class_ $class): array
    {
        ...
        $this->callableNodeTraverser->traverseNodesWithCallable($class->stmts, function (Node $node) use (&$fetchedLocalPropertyNameToTypes): ?int {
