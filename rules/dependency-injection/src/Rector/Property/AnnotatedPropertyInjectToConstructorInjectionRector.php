...
final class AnnotatedPropertyInjectToConstructorInjectionRector extends AbstractRector
{
    ...
    public function __construct(PhpDocTypeChanger $phpDocTypeChanger, InjectParameterAnalyzer $injectParameterAnalyzer, InjectTagValueNodeToServiceTypeResolver $injectTagValueNodeToServiceTypeResolver, PropertyUsageAnalyzer $propertyUsageAnalyzer, NetteInjectPropertyAnalyzer $netteInjectPropertyAnalyzer, PhpDocTagRemover $phpDocTagRemover)
    {
    ...
    {
        return new RuleDefinition('Turns properties with `@inject` to private properties and constructor injection', [
...
CODE_SAMPLE
    ...
    private function refactorPropertyWithAnnotation(Property $property, Type $type, AbstractTagValueNode $tagValueNode): void
    {
