...
final class MoveVariableDeclarationNearReferenceRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Move variable declaration near its reference', [
...
CODE_SAMPLE
    ...
    {
        $loopNode = $this->betterNodeFinder->findFirstParentInstanceOf($node, [For_::class, While_::class, Foreach_::class, Do_::class]);
