...
CODE_SAMPLE
    ...
    {
        $interfaceClassNames = array_map(function (ClassReflection $interfaceReflection): string {
    ...
    private function removeParamTypeFromMethod(ClassLike $classLike, int $position, ClassMethod $classMethod): void
    {
