...
final class ChangeLocalPropertyToVariableRector extends AbstractRector
{
    ...
    public function __construct(ClassManipulator $classManipulator, PropertyFetchManipulator $propertyFetchManipulator, PropertyFetchWithVariableReplacer $propertyFetchWithVariableReplacer)
    {
...
CODE_SAMPLE
    ...
    private function isPropertyChanging(Node $node, string $privatePropertyName): bool
    {
        ...
        $this->traverseNodesWithCallable($node, function (Node $node) use (&$isPropertyChanging, $privatePropertyName): ?int {
