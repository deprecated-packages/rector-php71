...
final class PrivatizeLocalClassConstantRector extends AbstractRector implements ZeroCacheRectorInterface
{
    ...
    public function __construct(ParentClassConstantNodeFinder $parentClassConstantNodeFinder, ParentConstantReflectionResolver $parentConstantReflectionResolver)
    {
    ...
    {
        return new RuleDefinition('Finalize every class constant that is used only locally', [
...
CODE_SAMPLE
    ...
    private function findParentClassConstantAndRefactorIfPossible(string $class, string $constant): ?ConstantVisibility
    {
        ...
        if ($parentClassConst !== null) {
            ...
            return new ConstantVisibility($parentClassConst->isPublic(), $parentClassConst->isProtected(), $parentClassConst->isPrivate());
        ...
        return new ConstantVisibility($parentClassConstantReflection->isPublic(), $parentClassConstantReflection->isProtected(), $parentClassConstantReflection->isPrivate());
    }
     ...
     */
    private function changeConstantVisibility(ClassConst $classConst, array $directUseClasses, array $indirectUseClasses, ?ConstantVisibility $constantVisibility, string $class): void
    {
