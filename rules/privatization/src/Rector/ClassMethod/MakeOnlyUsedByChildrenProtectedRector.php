...
final class MakeOnlyUsedByChildrenProtectedRector extends AbstractRector
{
    ...
    public function __construct(ClassMethodExternalCallNodeAnalyzer $classMethodExternalCallNodeAnalyzer, FamilyRelationsAnalyzer $familyRelationsAnalyzer)
    {
    ...
    {
        return new RuleDefinition('Make public class method protected, if only used by its children', [
