...
final class DoctrineItemDefaultValueManipulator
{
     ...
     */
    public function remove(PhpDocInfo $phpDocInfo, AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue): void
    {
     ...
     * @param string|bool|int $defaultValue
     */
    private function hasItemWithDefaultValue(AbstractDoctrineTagValueNode $doctrineTagValueNode, string $item, $defaultValue): bool
    {
