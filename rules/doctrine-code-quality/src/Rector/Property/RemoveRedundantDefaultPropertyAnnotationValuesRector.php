...
final class RemoveRedundantDefaultPropertyAnnotationValuesRector extends AbstractRector
{
    ...
    public function __construct(DoctrinePropertyAnalyzer $doctrinePropertyAnalyzer, DoctrineItemDefaultValueManipulator $doctrineItemDefaultValueManipulator)
    {
    ...
    {
        return new RuleDefinition('Removes redundant default values from Doctrine ORM annotations on class property level', [
