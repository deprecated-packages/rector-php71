...
final class ChangeBigIntEntityPropertyToIntTypeRector extends AbstractRector
{
    ...
    public function __construct(DoctrinePropertyAnalyzer $doctrinePropertyAnalyzer, DocBlockClassRenamer $docBlockClassRenamer)
    {
    ...
    {
        return new RuleDefinition('Change database type "bigint" for @var/type declaration to string', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $this->docBlockClassRenamer->renamePhpDocTypes($phpDocInfo->getPhpDocNode(), [new IntegerType(), new FloatType(), new BooleanType()], new StringType(), $node);
        return $node;
    }
}
