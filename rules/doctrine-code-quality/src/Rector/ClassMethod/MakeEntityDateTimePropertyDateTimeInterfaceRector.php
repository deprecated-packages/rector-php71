...
final class MakeEntityDateTimePropertyDateTimeInterfaceRector extends AbstractRector
{
    ...
    public function __construct(SetterClassMethodAnalyzer $setterClassMethodAnalyzer, PropertyTypeManipulator $propertyTypeManipulator)
    {
    ...
    {
        return new RuleDefinition('Make maker bundle generate DateTime property accept DateTimeInterface too', [
