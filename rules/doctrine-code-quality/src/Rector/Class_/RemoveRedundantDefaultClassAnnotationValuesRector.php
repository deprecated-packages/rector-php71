...
final class RemoveRedundantDefaultClassAnnotationValuesRector extends AbstractRector
{
    ...
    public function __construct(DoctrineClassAnalyzer $doctrineClassAnalyzer, DoctrineItemDefaultValueManipulator $doctrineItemDefaultValueManipulator)
    {
    ...
    {
        return new RuleDefinition('Removes redundant default values from Doctrine ORM annotations on class level', [
