...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $this->classDependencyManipulator->addConstructorDependencyWithCustomAssign($node, 'entityManager', new ObjectType(EntityManagerInterface::class), $repositoryAssign);
        return $node;
    }
}
