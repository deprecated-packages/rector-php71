...
final class FormTypeInstanceToClassConstRector extends AbstractFormAddRector
{
    ...
    public function __construct(BuilderFormNodeFactory $builderFormNodeFactory, ConfigureOptionsNodeFactory $configureOptionsNodeFactory)
    {
    ...
    {
        return new RuleDefinition('Changes createForm(new FormType), add(new FormType) to ones with "FormType::class"', [
