...
final class RemoveDeadRecursiveClassMethodRector extends AbstractRector implements ZeroCacheRectorInterface
{
    ...
    public function __construct(ClassMethodAndCallMatcher $classMethodAndCallMatcher, ClassMethodVendorLockResolver $classMethodVendorLockResolver)
    {
    ...
    {
        return new RuleDefinition('Remove unused public method that only calls itself recursively', [
...
CODE_SAMPLE
    ...
    /**
     * @param object $methodCall
     */
    private function shouldSkipCall(ClassMethod $classMethod, $methodCall): bool
    {
