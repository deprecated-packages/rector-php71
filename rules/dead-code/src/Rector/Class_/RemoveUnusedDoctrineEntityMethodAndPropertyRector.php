...
final class RemoveUnusedDoctrineEntityMethodAndPropertyRector extends AbstractRector implements ZeroCacheRectorInterface
{
    ...
    public function __construct(ClassManipulator $classManipulator, ClassUnusedPrivateClassMethodResolver $classUnusedPrivateClassMethodResolver, DoctrineEntityManipulator $doctrineEntityManipulator)
    {
    ...
    {
        return new RuleDefinition('Removes unused methods and properties from Doctrine entity classes', [
