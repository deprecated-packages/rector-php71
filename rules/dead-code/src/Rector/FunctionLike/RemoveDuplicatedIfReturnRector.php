...
final class RemoveDuplicatedIfReturnRector extends AbstractRector
{
    ...
    public function __construct(IfManipulator $ifManipulator, ModifiedVariableNamesCollector $modifiedVariableNamesCollector)
    {
    ...
    {
        return new RuleDefinition('Remove duplicated if stmt with return in function/method body', [
