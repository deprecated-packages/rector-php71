...
final class RemoveSetterOnlyPropertyAndMethodCallRector extends AbstractRector
{
    ...
    public function __construct(PropertyManipulator $propertyManipulator, VendorLockResolver $vendorLockResolver, PropertyFetchFinder $propertyFetchFinder)
    {
    ...
    {
        return new RuleDefinition('Removes method that set values that are never used', [
