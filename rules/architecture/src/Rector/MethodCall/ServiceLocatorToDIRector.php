...
final class ServiceLocatorToDIRector extends AbstractRector
{
    ...
    public function __construct(DoctrineEntityAndRepositoryMapperInterface $doctrineEntityAndRepositoryMapper, PropertyNaming $propertyNaming)
    {
    ...
    {
        return new RuleDefinition('Turns $this->getRepository() in Symfony Controller to constructor injection and private property access.', [
...
CODE_SAMPLE
    ...
    private function resolveRepositoryFqnFromGetRepositoryMethodCall(MethodCall $methodCall): string
    {
        ...
        throw new RectorProviderException(sprintf('A repository was not provided for "%s" entity by your "%s" class.', $entityFqnOrAlias, get_class($this->doctrineEntityAndRepositoryMapper)));
    }
