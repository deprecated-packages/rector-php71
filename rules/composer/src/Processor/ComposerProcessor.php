...
final class ComposerProcessor
{
    ...
    public function __construct(ComposerJsonFactory $composerJsonFactory, ComposerJsonPrinter $composerJsonPrinter, Configuration $configuration, ErrorAndDiffCollector $errorAndDiffCollector, SmartFileSystem $smartFileSystem, ComposerModifier $composerModifier)
    {
    ...
    private function addComposerJsonFileDiff(ComposerJson $oldComposerJson, ComposerJson $newComposerJson, SmartFileInfo $smartFileInfo): void
    {
