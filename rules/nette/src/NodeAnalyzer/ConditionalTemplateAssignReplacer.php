...
final class ConditionalTemplateAssignReplacer
{
    ...
    public function processClassMethod(ClassMethod $classMethod, MagicTemplatePropertyCalls $magicTemplatePropertyCalls): void
    {
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable((array) $classMethod->stmts, function (Node $node) use ($magicTemplatePropertyCalls): ?Assign {
