...
final class RightAssignTemplateRemover
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, ThisTemplatePropertyFetchAnalyzer $thisTemplatePropertyFetchAnalyzer, NodeRemover $nodeRemover)
    {
