...
final class RenderMethodAnalyzer
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, NodeNameResolver $nodeNameResolver, ScopeNestingComparator $scopeNestingComparator)
    {
