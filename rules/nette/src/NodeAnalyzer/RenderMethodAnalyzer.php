...
final class RenderMethodAnalyzer
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, NodeNameResolver $nodeNameResolver, ScopeNestingComparator $scopeNestingComparator, BetterNodeFinder $betterNodeFinder)
    {
    ...
    public function hasConditionalTemplateAssigns(ClassMethod $classMethod): bool
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable($classMethod, function (Node $node) use (&$hasConditionalAssigns): ?int {
