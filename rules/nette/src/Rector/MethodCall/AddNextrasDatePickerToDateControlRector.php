...
final class AddNextrasDatePickerToDateControlRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Nextras/Form upgrade of addDatePicker method call to DateControl assign', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if ($node->var instanceof MethodCall) {
            if (! $this->isOnClassMethodCall($node->var, new ObjectType('Nette\Application\UI\Form'), 'addDatePicker')) {
                return null;
            }
