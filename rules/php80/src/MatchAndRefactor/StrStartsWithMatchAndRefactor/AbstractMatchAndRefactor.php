...
abstract class AbstractMatchAndRefactor
{
     ...
     * @required
     */
    public function autowireAbstractMatchAndRefactor(NodeNameResolver $nodeNameResolver, ValueResolver $valueResolver, BetterStandardPrinter $betterStandardPrinter, NodeComparator $nodeComparator): void
    {
    ...
    protected function createStrStartsWithValueObjectFromFuncCall(FuncCall $funcCall, bool $isPositive): StrStartsWith
    {
