...
final class ClassPropertyAssignToConstructorPromotionRector extends AbstractRector
{
    ...
    public function __construct(PromotedPropertyResolver $promotedPropertyResolver, VariableRenamer $variableRenamer, VarTagRemover $varTagRemover, PhpDocTagRemover $phpDocTagRemover)
    {
    ...
    {
        return new RuleDefinition('Change simple property init and assign to constructor promotion', [
