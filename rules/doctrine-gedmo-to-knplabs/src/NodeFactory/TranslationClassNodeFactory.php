...
final class TranslationClassNodeFactory
{
    ...
    public function __construct(PhpDocInfoFactory $phpDocInfoFactory, ClassInsertManipulator $classInsertManipulator, EntityTagValueNodeFactory $entityTagValueNodeFactory)
    {
