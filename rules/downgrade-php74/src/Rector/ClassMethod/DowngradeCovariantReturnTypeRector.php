...
CODE_SAMPLE
    ...
    private function getDifferentReturnTypeNameFromAncestorClass(ClassMethod $classMethod): ?string
    {
        ...
        $nodeReturnTypeName = $this->getName($nodeReturnType instanceof NullableType ? $nodeReturnType->type : $nodeReturnType);
        /** @var string $methodName */
        $methodName = $this->getName($classMethod->name);
        // Either Ancestor classes or implemented interfaces
        $parentClassNames = array_merge($classReflection->getParentClassesNames(), array_map(function (ClassReflection $interfaceReflection): string {
