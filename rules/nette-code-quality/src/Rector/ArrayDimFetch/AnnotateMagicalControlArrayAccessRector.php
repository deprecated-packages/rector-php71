...
final class AnnotateMagicalControlArrayAccessRector extends AbstractArrayDimFetchToAnnotatedControlVariableRector
{
    ...
    public function __construct(MethodNamesByInputNamesResolver $methodNamesByInputNamesResolver, ArrayDimFetchRenamer $arrayDimFetchRenamer)
    {
    ...
    {
        return new RuleDefinition('Change magic $this["some_component"] to variable assign with @var annotation', [
