...
abstract class AbstractArrayDimFetchToAnnotatedControlVariableRector extends AbstractRector
{
     ...
     * @required
     */
    public function autowireAbstractArrayDimFetchToAnnotatedControlVariableRector(VarAnnotationManipulator $varAnnotationManipulator, ControlDimFetchAnalyzer $controlDimFetchAnalyzer, NetteControlNaming $netteControlNaming, FunctionLikeFirstLevelStatementResolver $functionLikeFirstLevelStatementResolver): void
    {
    ...
    protected function addAssignExpressionForFirstCase(string $variableName, ArrayDimFetch $arrayDimFetch, ObjectType $controlObjectType): void
    {
