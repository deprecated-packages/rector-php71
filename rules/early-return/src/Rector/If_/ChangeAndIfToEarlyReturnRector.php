...
final class ChangeAndIfToEarlyReturnRector extends AbstractRector
{
    ...
    public function __construct(ConditionInverter $conditionInverter, IfManipulator $ifManipulator, StmtsManipulator $stmtsManipulator)
    {
...
CODE_SAMPLE
    ...
    private function isNestedIfInLoop(If_ $if): bool
    {
        ...
        return (bool) $this->betterNodeFinder->findFirstParentInstanceOf($if, [If_::class, Else_::class, ElseIf_::class]);
    }
