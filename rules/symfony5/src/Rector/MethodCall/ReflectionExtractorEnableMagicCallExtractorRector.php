...
CODE_SAMPLE
    ...
    {
        $classConstFetch = $this->createClassConstFetch('Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor', 'MAGIC_GET');
        ...
        return new BitwiseOr(new BitwiseOr($this->createClassConstFetch('Symfony\Component\PropertyInfo\Extractor\ReflectionExtractor', 'MAGIC_CALL'), $classConstFetch), $magicSet);
    }
}
