...
final class NonInformativeReturnTagRemover
{
    ...
    private function removeNonUniqueUselessDocNames(Type $returnType, AttributeAwareReturnTagValueNode $attributeAwareReturnTagValueNode, PhpDocInfo $phpDocInfo): void
    {
    ...
    private function removeShortObjectType(Type $returnType, AttributeAwareReturnTagValueNode $attributeAwareReturnTagValueNode, PhpDocInfo $phpDocInfo): void
    {
    ...
    private function removeNullableType(Type $returnType, AttributeAwareReturnTagValueNode $attributeAwareReturnTagValueNode, PhpDocInfo $phpDocInfo): void
    {
    ...
    private function removeFullyQualifiedObjectType(Type $returnType, AttributeAwareReturnTagValueNode $attributeAwareReturnTagValueNode, PhpDocInfo $phpDocInfo): void
    {
    ...
    private function matchNullabledReturnTagValueNode(AttributeAwareReturnTagValueNode $attributeAwareReturnTagValueNode): ?TypeNode
    {
