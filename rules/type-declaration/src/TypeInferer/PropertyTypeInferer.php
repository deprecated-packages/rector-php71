...
final class PropertyTypeInferer extends AbstractPriorityAwareTypeInferer
{
     ...
     */
    public function __construct(array $propertyTypeInferers, DefaultValuePropertyTypeInferer $defaultValuePropertyTypeInferer, VarDocPropertyTypeInferer $varDocPropertyTypeInferer, TypeFactory $typeFactory, DoctrineTypeAnalyzer $doctrineTypeAnalyzer)
    {
