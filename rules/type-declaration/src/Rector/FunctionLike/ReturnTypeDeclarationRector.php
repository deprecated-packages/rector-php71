...
final class ReturnTypeDeclarationRector extends AbstractTypeDeclarationRector
{
    ...
    {
        return new RuleDefinition('Change @return types and type from static analysis to type declarations if not a BC-break', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $inferredReturnNode = $this->staticTypeMapper->mapPHPStanTypeToPhpParserNode($inferedType, PHPStanStaticTypeMapper::KIND_RETURN);
