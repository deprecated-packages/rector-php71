...
final class ParamTypeFromStrictTypedPropertyRector extends AbstractRector
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, ReflectionTypeResolver $reflectionTypeResolver)
    {
...
CODE_SAMPLE
    ...
    public function decorateParamWithType(FunctionLike $functionLike, Param $param): void
    {
        ...
        $this->simpleCallableNodeTraverser->traverseNodesWithCallable((array) $functionLike->getStmts(), function (Node $node) use ($param): ?int {
