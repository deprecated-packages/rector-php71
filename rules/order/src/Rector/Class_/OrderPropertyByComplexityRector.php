...
final class OrderPropertyByComplexityRector extends AbstractConstantPropertyMethodOrderRector
{
    ...
    {
        return new RuleDefinition('Order properties by complexity, from the simplest like scalars to the most complex, like union or collections', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        foreach ($propertyByVisibilityByPosition as $propertyByPosition) {
            ...
            foreach ($propertyByPosition as $position => $property) {
                ...
                $propertyNamesRanksAndPositions[] = new PropertyNameRankAndPosition($propertyName, $rank, $position);
            }
    ...
    {
        uasort($propertyNamesRanksAndPositions, function (PropertyNameRankAndPosition $firstArray, PropertyNameRankAndPosition $secondArray): int {
