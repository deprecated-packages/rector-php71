...
final class ChangeConstantVisibilityRector extends AbstractRector implements ConfigurableRectorInterface
{
    ...
    {
        return new RuleDefinition('Change visibility of constant from parent class.', [
...
, [
                self::CLASS_CONSTANT_VISIBILITY_CHANGES => [
                    new ClassConstantVisibilityChange('ParentObject', 'SOME_CONSTANT', Visibility::PROTECTED),
                ],
            ]),
        ]);
    }
