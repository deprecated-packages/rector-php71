...
final class AddFlashRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Turns long flash adding to short helper method in Controller in Symfony', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if (! $this->fluentChainMethodCallNodeAnalyzer->isTypeAndChainCalls($node, new ObjectType(Request::class), ['getSession', 'getFlashBag', 'add'])
        ) {
            return null;
        }
