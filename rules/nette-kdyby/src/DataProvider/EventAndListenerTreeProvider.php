...
final class EventAndListenerTreeProvider
{
    ...
    public function __construct(DispatchMethodCallFactory $dispatchMethodCallFactory, EventClassNaming $eventClassNaming, EventValueObjectClassFactory $eventValueObjectClassFactory, GetSubscribedEventsClassMethodProvider $getSubscribedEventsClassMethodProvider, ListeningMethodsCollector $listeningMethodsCollector, NodeNameResolver $nodeNameResolver, OnPropertyMagicCallProvider $onPropertyMagicCallProvider)
    {
    ...
    private function initializeEventAndListenerTrees(): void
    {
        ...
        foreach ($this->onPropertyMagicCallProvider->provide() as $methodCall) {
            ...
            $eventAndListenerTree = new EventAndListenerTree($methodCall, $magicProperty, $eventClassName, $eventFileLocation, $eventClassInNamespace, $dispatchMethodCall, $listeningClassMethodsByClass, $getterMethodsBlueprints);
