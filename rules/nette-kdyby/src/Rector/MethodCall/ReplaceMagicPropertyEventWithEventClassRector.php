...
final class ReplaceMagicPropertyEventWithEventClassRector extends AbstractRector
{
    ...
    public function __construct(ClassNaming $classNaming, EventAndListenerTreeProvider $eventAndListenerTreeProvider)
    {
    ...
    {
        return new RuleDefinition('Change $onProperty magic call with event disptacher and class dispatch', [
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $this->addConstructorDependencyToClass($classLike, new FullyQualifiedObjectType(EventDispatcherInterface::class), 'eventDispatcher');
        // 6. remove property
