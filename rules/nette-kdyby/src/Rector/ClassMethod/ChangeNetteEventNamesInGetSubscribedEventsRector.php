...
final class ChangeNetteEventNamesInGetSubscribedEventsRector extends AbstractKdybyEventSubscriberRector
{
    ...
    public function __construct(GetSubscribedEventsArrayManipulator $getSubscribedEventsArrayManipulator, ListeningClassMethodArgumentManipulator $listeningClassMethodArgumentManipulator, ListeningMethodsCollector $listeningMethodsCollector)
    {
    ...
    {
        return new RuleDefinition('Change EventSubscriber from Kdyby to Contributte', [
