...
final class ReplaceMagicPropertyWithEventClassRector extends AbstractKdybyEventSubscriberRector
{
    ...
    public function __construct(EventAndListenerTreeProvider $eventAndListenerTreeProvider, EventClassNaming $eventClassNaming, ListeningClassMethodArgumentManipulator $listeningClassMethodArgumentManipulator)
    {
    ...
    {
        return new RuleDefinition('Change getSubscribedEvents() from on magic property, to Event class', [
