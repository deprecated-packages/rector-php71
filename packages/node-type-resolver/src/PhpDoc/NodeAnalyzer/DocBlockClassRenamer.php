...
final class DocBlockClassRenamer
{
     ...
     * @param Type[] $oldTypes
     */
    public function renamePhpDocTypes(PhpDocNode $phpDocNode, array $oldTypes, Type $newType, Node $phpParserNode): void
    {
    ...
    public function renamePhpDocType(PhpDocNode $phpDocNode, Type $oldType, Type $newType, Node $phpParserNode): bool
    {
        $this->phpDocNodeTraverser->traverseWithCallable($phpDocNode, '', function (PhpDocParserNode $node) use ($phpParserNode, $oldType, $newType): PhpDocParserNode {
