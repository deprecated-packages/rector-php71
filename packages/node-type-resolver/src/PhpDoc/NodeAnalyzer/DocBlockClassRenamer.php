...
final class DocBlockClassRenamer
{
     ...
     * @param Type[] $oldTypes
     */
    public function renamePhpDocTypes(PhpDocInfo $phpDocInfo, array $oldTypes, Type $newType, Node $phpParserNode): void
    {
    ...
    public function renamePhpDocType(PhpDocInfo $phpDocInfo, Type $oldType, Type $newType, Node $phpParserNode): void
    {
        $this->phpDocNodeTraverser->traverseWithCallable($phpDocInfo->getPhpDocNode(), '', function (PhpDocParserNode $node) use ($phpDocInfo, $phpParserNode, $oldType, $newType): PhpDocParserNode {
