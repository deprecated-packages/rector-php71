...
final class PropertyFetchTypeResolver implements NodeTypeResolverInterface
{
    ...
    public function __construct(BetterPhpDocParser $betterPhpDocParser, NodeNameResolver $nodeNameResolver, ParsedNodeCollector $parsedNodeCollector, StaticTypeMapper $staticTypeMapper, TraitNodeScopeCollector $traitNodeScopeCollector)
    {
