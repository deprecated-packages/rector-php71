...
final class ParamTypeResolver implements NodeTypeResolverInterface
{
    ...
    public function __construct(SimpleCallableNodeTraverser $simpleCallableNodeTraverser, NodeNameResolver $nodeNameResolver, PhpDocInfoFactory $phpDocInfoFactory)
    {
     ...
     * @required
     */
    public function autowireParamTypeResolver(NodeTypeResolver $nodeTypeResolver, StaticTypeMapper $staticTypeMapper): void
    {
