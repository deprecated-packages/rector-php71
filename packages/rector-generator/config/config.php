...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->defaults()
        ->public()
        ->autowire()
        ->autoconfigure()->bind(AddNewServiceToSymfonyPhpConfigRector::class, service(AddNewServiceToSymfonyPhpConfigRector::class));
    ...
    $services->set(AddNewServiceToSymfonyPhpConfigRector::class)->autowire(false);
