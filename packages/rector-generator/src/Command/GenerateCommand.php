...
final class GenerateCommand extends Command
{
    ...
    public function __construct(ComposerPackageAutoloadUpdater $composerPackageAutoloadUpdater, ConfigFilesystem $configFilesystem, FileGenerator $fileGenerator, OverrideGuard $overrideGuard, SymfonyStyle $symfonyStyle, TemplateFinder $templateFinder, TemplateVariablesFactory $templateVariablesFactory, RectorRecipeProvider $rectorRecipeProvider, RectorRecipeInteractiveFactory $rectorRecipeInteractiveFactory)
    {
        parent::__construct();
    ...
    protected function configure(): void
    {
        ...
        $this->addOption(self::INTERACTIVE_MODE_NAME, 'i', InputOption::VALUE_NONE, 'Turns on Interactive Mode - Rector will be generated based on responses to questions instead of using rector-recipe.php');
    }
