...
final class ComposerPackageAutoloadUpdater
{
    ...
    private function resolvePackage(RectorRecipe $rectorRecipe): Package
    {
        if (! $rectorRecipe->isRectorRepository()) {
            return new Package('Utils\\Rector\\', 'Utils\\Rector\\Tests\\', 'utils/rector/src', 'utils/rector/tests');
        }
        return new Package('Rector\\' . $rectorRecipe->getPackage() . '\\', 'Rector\\' . $rectorRecipe->getPackage() . '\\Tests\\', 'rules/' . $rectorRecipe->getPackageDirectory() . '/src', 'rules/' . $rectorRecipe->getPackageDirectory() . '/tests');
    }
