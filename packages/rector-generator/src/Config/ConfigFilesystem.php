...
final class ConfigFilesystem
{
    ...
    public function __construct(AddNewServiceToSymfonyPhpConfigRector $addNewServiceToSymfonyPhpConfigRector, BetterStandardPrinter $betterStandardPrinter, Parser $parser, SmartFileSystem $smartFileSystem, TemplateFactory $templateFactory)
    {
