...
final class ConfigurationNodeFactory
{
    ...
    public function __construct(NodeFactory $nodeFactory, ParameterProvider $parameterProvider, PhpDocInfoFactory $phpDocInfoFactory)
    {
    ...
    {
        $this->parameterProvider->changeParameter(Option::PHP_VERSION_FEATURES, PhpVersionFeature::TYPED_PROPERTIES - 1);
    }
