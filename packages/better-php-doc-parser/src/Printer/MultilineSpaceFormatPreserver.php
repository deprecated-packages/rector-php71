...
final class MultilineSpaceFormatPreserver
{
     ...
     */
    public function fixMultilineDescriptions(AttributeAwareNodeInterface $attributeAwareNode): AttributeAwareNodeInterface
    {
     ...
     */
    private function restoreOriginalSpacingInText(AttributeAwareNodeInterface $attributeAwareNode): ?AttributeAwareNodeInterface
    {
    ...
    private function setNewTextToPhpDocNode(AttributeAwareNodeInterface $attributeAwareNode, string $newText): AttributeAwareNodeInterface
    {
        if ($attributeAwareNode instanceof PhpDocTagNode && property_exists($attributeAwareNode->value, 'description')) {
