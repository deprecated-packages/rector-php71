...
final class TagValueNodePrinter
{
     ...
     * @return mixed[]
     */
    public function completeItemsQuotes(TagValueNodeConfiguration $tagValueNodeConfiguration, array $items, array $skipKeys = []): array
    {
     ...
     */
    private function shouldSkipFromExplicitKey($contentItem, string $key, TagValueNodeConfiguration $tagValueNodeConfiguration): bool
    {
