...
final class ArrayPartPhpDocTagPrinter
{
     ...
     * @param mixed[] $item
     */
    public function printArrayItem(array $item, ?string $key, TagValueNodeConfiguration $tagValueNodeConfiguration): string
    {
     ...
     */
    private function replaceColonWithEqualInSymfonyAndDoctrine(string $content, TagValueNodeConfiguration $tagValueNodeConfiguration): string
    {
        return Strings::replace($content, '#(\"|\w)\:(\"|\w)#', '$1' . $tagValueNodeConfiguration->getArrayEqualSign() . '$2');
    }
