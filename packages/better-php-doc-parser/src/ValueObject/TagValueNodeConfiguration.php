...
final class TagValueNodeConfiguration
{
     ...
     */
    public function __construct(?string $originalContent = null, ?array $orderedVisibleItems = null, bool $hasNewlineAfterOpening = false, bool $hasNewlineBeforeClosing = false, bool $hasOpeningBracket = false, bool $hasClosingBracket = false, array $keysByQuotedStatus = [], ?string $silentKey = null, bool $isSilentKeyExplicit = true, string $arrayEqualSign = ':')
    {
    ...
    /**
     * @param mixed $tagValueNodeConfiguration
     */
