...
abstract class AbstractPhpDocNodeFactory
{
     ...
     * @required
     */
    public function autowireAbstractPhpDocNodeFactory(NodeAnnotationReader $nodeAnnotationReader, AnnotationContentResolver $annotationContentResolver, AnnotationItemsResolver $annotationItemsResolver, ObjectTypeSpecifier $objectTypeSpecifier): void
    {
