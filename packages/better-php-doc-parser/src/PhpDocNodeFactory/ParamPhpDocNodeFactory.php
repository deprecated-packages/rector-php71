...
final class ParamPhpDocNodeFactory
{
    ...
    public function __construct(AnnotationContentResolver $annotationContentResolver, AttributeAwareNodeFactory $attributeAwareNodeFactory, PrivatesAccessor $privatesAccessor, PrivatesCaller $privatesCaller)
    {
