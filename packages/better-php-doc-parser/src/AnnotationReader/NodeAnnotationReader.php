...
final class NodeAnnotationReader
{
    ...
    public function __construct(ConstantReferenceIdentifierRestorer $constantReferenceIdentifierRestorer, NodeNameResolver $nodeNameResolver, Reader $reader)
    {
        $this->reader = $reader;
     ...
     * @return object|null
     */
    private function matchNextAnnotation(array $annotations, string $annotationClassName, Node $node)
    {
