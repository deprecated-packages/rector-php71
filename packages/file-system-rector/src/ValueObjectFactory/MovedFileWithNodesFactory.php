...
final class MovedFileWithNodesFactory
{
    ...
    public function __construct(BetterNodeFinder $betterNodeFinder, CategoryNamespaceProvider $categoryNamespaceProvider, FileRelocationResolver $fileRelocationResolver)
    {
     ...
     * @param Node[] $nodes
     */
    public function createWithDesiredGroup(SmartFileInfo $oldFileInfo, array $nodes, string $desiredGroupName): ?MovedFileWithNodes
    {
