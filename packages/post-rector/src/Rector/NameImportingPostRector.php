...
final class NameImportingPostRector extends AbstractPostRector
{
    ...
    {
        return new RuleDefinition('Imports fully qualified class names in parameter types, return types, extended classes, implemented, interfaces and even docblocks', [
