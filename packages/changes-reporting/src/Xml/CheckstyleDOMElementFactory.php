...
final class CheckstyleDOMElementFactory
{
    ...
    private function createNonFileErrorDOMElements(DOMDocument $domDocument, ErrorAndDiffCollector $errorAndDiffCollector): ?DOMElement
    {
    ...
    private function createErrorDOMElement(RectorWithFileAndLineChange $rectorWithFileAndLineChange, DOMDocument $domDocument): DOMElement
    {
