...
final class RectorChangeCollector
{
    ...
    {
        return array_filter($this->rectorWithFileAndLineChanges, function (RectorWithFileAndLineChange $rectorWithFileAndLineChange) use ($smartFileInfo): bool {
    ...
    {
        $this->rectorWithFileAndLineChanges[] = new RectorWithFileAndLineChange($rector, $smartFileInfo->getRealPath(), $line);
    }
}
