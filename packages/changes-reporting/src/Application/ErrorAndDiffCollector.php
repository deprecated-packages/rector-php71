...
final class ErrorAndDiffCollector
{
    ...
    public function __construct(DifferAndFormatter $differAndFormatter, ExceptionCorrector $exceptionCorrector, NodesToRemoveCollector $nodesToRemoveCollector, RectorChangeCollector $rectorChangeCollector, RemovedAndAddedFilesCollector $removedAndAddedFilesCollector)
    {
    ...
    public function addFileDiff(SmartFileInfo $smartFileInfo, string $newContent, string $oldContent): void
    {
        ...
        $this->fileDiffs[$smartFileInfo->getRealPath()] = new FileDiff($smartFileInfo, $this->differAndFormatter->diff($oldContent, $newContent), $this->differAndFormatter->diffAndFormat($oldContent, $newContent), $rectorChanges);
    }
    ...
    public function addErrorWithRectorClassMessageAndFileInfo(string $rectorClass, string $message, SmartFileInfo $smartFileInfo): void
    {
