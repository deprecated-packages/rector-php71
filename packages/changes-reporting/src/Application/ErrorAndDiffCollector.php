...
final class ErrorAndDiffCollector
{
    ...
    public function __construct(ExceptionCorrector $exceptionCorrector, NodesToRemoveCollector $nodesToRemoveCollector, RectorChangeCollector $rectorChangeCollector, RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, ConsoleDiffer $consoleDiffer, DefaultDiffer $defaultDiffer)
    {
    ...
    public function addFileDiff(SmartFileInfo $smartFileInfo, string $newContent, string $oldContent): void
    {
        ...
        $fileDiff = new FileDiff($smartFileInfo, $this->defaultDiffer->diff($oldContent, $newContent), $this->consoleDiffer->diff($oldContent, $newContent), $rectorChanges);
