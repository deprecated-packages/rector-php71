...
final class CachedFileInfoFilterAndReporter
{
    ...
    public function __construct(Configuration $configuration, ChangedFilesDetector $changedFilesDetector, SymfonyStyle $symfonyStyle, UnchangedFilesFilter $unchangedFilesFilter)
    {
