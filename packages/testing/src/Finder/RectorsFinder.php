    ...
    public function findInDirectoriesAndCreate(array $directories): array
    {
        ...
        foreach ($foundClasses as $class) {
            ...
            if (! $rector instanceof RectorInterface) {
                ...
                throw new ShouldNotHappenException(sprintf('"%s" found something that looks like Rector but does not implements "%s" interface.', __METHOD__, RectorInterface::class));
            }
