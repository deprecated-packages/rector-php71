...
final class ReadWritePropertyAnalyzer
{
    ...
    public function __construct(VariableToConstantGuard $variableToConstantGuard, AssignManipulator $assignManipulator, ReadExprAnalyzer $readExprAnalyzer, BetterNodeFinder $betterNodeFinder)
    {
