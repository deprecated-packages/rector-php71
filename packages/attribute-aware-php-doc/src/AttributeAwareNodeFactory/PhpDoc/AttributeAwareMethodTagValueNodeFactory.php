...
final class AttributeAwareMethodTagValueNodeFactory implements AttributeNodeAwareFactoryInterface, AttributeAwareNodeFactoryAwareInterface
{
    ...
    public function create(Node $node, string $docContent): AttributeAwareNodeInterface
    {
        ...
        return new AttributeAwareMethodTagValueNode($node->isStatic, $returnType, $node->methodName, $node->parameters, $node->description);
    }
    ...
    private function attributizeReturnType(MethodTagValueNode $methodTagValueNode, string $docContent): ?AttributeAwareNodeInterface
    {
