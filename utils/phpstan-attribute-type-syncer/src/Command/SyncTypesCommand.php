...
final class SyncTypesCommand extends AbstractCommand
{
    ...
    public function __construct(AttributeAwareNodeFactoryCollector $attributeAwareNodeFactoryCollector, AttributeAwareNodeFactoryGenerator $attributeAwareNodeFactoryGenerator, AttributeAwareNodeGenerator $attributeAwareNodeGenerator, NodeClassFinder $nodeClassFinder, SymfonyStyle $symfonyStyle)
    {
