...
abstract class AbstractClassSyncer implements ClassSyncerInterface
{
     ...
     * @required
     */
    public function autowireAbstractClassSyncer(BetterStandardPrinter $betterStandardPrinter, FileInfoParser $fileInfoParser, SmartFileSystem $smartFileSystem, ClassSyncerNodeTraverser $classSyncerNodeTraverser): void
    {
