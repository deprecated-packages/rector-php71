...
final class ValidateFixtureNamespaceCommand extends Command
{
    ...
    public function __construct(SymfonyStyle $symfonyStyle, SmartFileSystem $smartFileSystem, FixtureFinder $fixtureFinder, NamespaceMatcher $namespaceMatcher, ExpectedNameResolver $expectedNameResolver)
    {
        parent::__construct();
