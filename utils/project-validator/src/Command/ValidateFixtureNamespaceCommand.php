...
final class ValidateFixtureNamespaceCommand extends Command
{
    ...
    public function __construct(FinderSanitizer $finderSanitizer, SymfonyStyle $symfonyStyle, SmartFileSystem $smartFileSystem, FixtureFinder $fixtureFinder, NamespaceMatcher $namespaceMatcher, ExpectedNameResolver $expectedNameResolver)
    {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($incorrectNamespaceFiles !== []) {
            ...
            $message = sprintf('Found %d fixture files with invalid namespace which not follow psr-4 defined in composer.json', count($incorrectNamespaceFiles));
    ...
    private function fixNamespace(string $incorrectNamespaceFile, string $incorrectNamespace, string $incorrectFileContent, string $expectedNamespace): void
    {
