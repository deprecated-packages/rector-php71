...
final class DumpNodesCommand extends AbstractCommand
{
    ...
    public function __construct(MarkdownNodeInfosPrinter $markdownNodeInfosPrinter, NodeInfosFactory $nodeInfosFactory, SmartFileSystem $smartFileSystem, SymfonyStyle $symfonyStyle)
    {
    ...
    protected function configure(): void
    {
        ...
        $this->addOption(self::OUTPUT_FILE, null, InputOption::VALUE_REQUIRED, 'Where to output the file', getcwd() . '/docs/nodes_overview.md');
    }
