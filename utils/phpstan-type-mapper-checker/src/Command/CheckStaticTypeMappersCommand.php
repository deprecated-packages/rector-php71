...
final class CheckStaticTypeMappersCommand extends AbstractCommand
{
    ...
    public function __construct(SymfonyStyle $symfonyStyle, MissingPHPStanTypeMappersResolver $missingPHPStanTypeMappersResolver)
    {
        parent::__construct();
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($missingTypeNodeClasses as $missingDocTypeNodeClass) {
            $errorMessage = sprintf('Add new class to "%s" that implements "%s" for "%s" type', 'packages/phpstan-static-type-mapper/src/TypeMapper', TypeMapperInterface::class, $missingDocTypeNodeClass);
