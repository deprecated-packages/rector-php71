...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(AddParamTypeDeclarationRector::class)->call('configure', [[
        AddParamTypeDeclarationRector::PARAMETER_TYPEHINTS => ValueObjectInliner::inline([
            new AddParamTypeDeclaration('Nette\ComponentModel\Component', 'lookup', 0, new UnionType([new StringType(), new NullType()])),
            ...
            new AddParamTypeDeclaration('Nette\ComponentModel\Component', 'attached', 0, new ObjectType('Nette\ComponentModel\IComponent')),
            new AddParamTypeDeclaration('Nette\ComponentModel\Component', 'detached', 0, new ObjectType('Nette\ComponentModel\IComponent')),
            ...
            new AddParamTypeDeclaration('Nette\ComponentModel\IComponent', 'setParent', 0, new UnionType([new ObjectType('Nette\ComponentModel\IContainer'), new NullType()])),
