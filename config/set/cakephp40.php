...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(AddReturnTypeDeclarationRector::class)->call('configure', [[
        AddReturnTypeDeclarationRector::METHOD_RETURN_TYPES => ValueObjectInliner::inline([
            ...
            new AddReturnTypeDeclaration('Cake\Http\BaseApplication', 'middleware', new ObjectType('Cake\Http\MiddlewareQueue')),
            ...
            new AddReturnTypeDeclaration('Cake\ORM\Table', 'validationDefault', new ObjectType('Cake\Validation\Validator')),
    ...
    $services->set(AddParamTypeDeclarationRector::class)->call('configure', [[
        AddParamTypeDeclarationRector::PARAMETER_TYPEHINTS => ValueObjectInliner::inline([
            new AddParamTypeDeclaration('Cake\Form\Form', 'getData', 0, new UnionType([new StringType(), new NullType()])),
    ...
    $services->set(RenameMethodCallBasedOnParameterRector::class)->call('configure', [[
