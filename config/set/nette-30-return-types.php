...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(AddReturnTypeDeclarationRector::class)->call('configure', [[
        AddReturnTypeDeclarationRector::METHOD_RETURN_TYPES => ValueObjectInliner::inline([
            ...
            new AddReturnTypeDeclaration('Nette\Forms\Rendering\DefaultFormRenderer', 'renderControl', new ObjectType('Nette\Utils\Html')),
            new AddReturnTypeDeclaration('Nette\Forms\Container', 'addContainer', new ObjectType('Nette\Forms\Container')),
            new AddReturnTypeDeclaration('Nette\Forms\Container', 'addSelect', new ObjectType('Nette\Forms\Controls\SelectBox')),
            new AddReturnTypeDeclaration('Nette\Forms\Container', 'addMultiSelect', new ObjectType('Nette\Forms\Controls\MultiSelectBox')),
            new AddReturnTypeDeclaration('Nette\Forms\IFormRenderer', 'render', new StringType()),
            new AddReturnTypeDeclaration('Nette\Forms\Controls\TextBase', 'getControl', new ObjectType('Nette\Utils\Html')),
            new AddReturnTypeDeclaration('RadekDostal\NetteComponents\DateTimePicker\DateTimePicker', 'register', new VoidType()),
            ...
            new AddReturnTypeDeclaration('Nette\Security\IAuthenticator', 'authenticate', new ObjectType('Nette\Security\IIdentity')),
            ...
            new AddReturnTypeDeclaration('Nette\Security\User', 'getStorage', new ObjectType('Nette\Security\IUserStorage')),
            ...
            new AddReturnTypeDeclaration('Nette\Security\User', 'getIdentity', new UnionType([new ObjectType('Nette\Security\IIdentity'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Security\User', 'getAuthenticator', new UnionType([new ObjectType('Nette\Security\IAuthenticator'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Security\User', 'getAuthorizator', new UnionType([new ObjectType('Nette\Security\IAuthorizator'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Security\User', 'getLogoutReason', new UnionType([new IntegerType(), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Security\IUserStorage', 'getIdentity', new UnionType([new ObjectType('Nette\Security\IIdentity'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Security\IUserStorage', 'getLogoutReason', new UnionType([new IntegerType(), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\Component', 'lookup', new ObjectType('Nette\ComponentModel\IComponent')),
            ...
            new AddReturnTypeDeclaration('Nette\ComponentModel\Component', 'getName', new UnionType([new StringType(), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\IComponent', 'getName', new UnionType([new StringType(), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\IComponent', 'getParent', new UnionType([new ObjectType('Nette\ComponentModel\IContainer'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\Container', 'removeComponent', new VoidType()),
            new AddReturnTypeDeclaration('Nette\ComponentModel\Container', 'getComponent', new UnionType([new ObjectType('Nette\ComponentModel\IComponent'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\Container', 'createComponent', new UnionType([new ObjectType('Nette\ComponentModel\IComponent'), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\ComponentModel\Container', '_isCloning', new UnionType([new ObjectType('Nette\ComponentModel\IComponent'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\IContainer', 'removeComponent', new VoidType()),
            new AddReturnTypeDeclaration('Nette\ComponentModel\IContainer', 'getComponent', new UnionType([new ObjectType('Nette\ComponentModel\IContainer'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\ComponentModel\IContainer', 'getComponents', new ObjectType('Iterator')),
            new AddReturnTypeDeclaration('Nette\Application\Application', 'run', new VoidType()),
            new AddReturnTypeDeclaration('Nette\Application\Application', 'createInitialRequest', new ObjectType('Nette\Application\Request')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\Application', 'getPresenter', new UnionType([new ObjectType('Nette\Application\IPresenter'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\Application', 'getRouter', new UnionType([new ObjectType('Nette\Application\IRouter'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\Application', 'getPresenterFactory', new UnionType([new ObjectType('Nette\Application\IPresenterFactory'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\Helpers', 'splitName', $arrayType),
            new AddReturnTypeDeclaration('Nette\Application\IPresenter', 'run', new ObjectType('Nette\Application\IResponse')),
            new AddReturnTypeDeclaration('Nette\Application\IPresenterFactory', 'getPresenterClass', new StringType()),
            new AddReturnTypeDeclaration('Nette\Application\IPresenterFactory', 'createPresenter', new ObjectType('Nette\Application\IPresenter')),
            new AddReturnTypeDeclaration('Nette\Application\PresenterFactory', 'formatPresenterClass', new StringType()),
            new AddReturnTypeDeclaration('Nette\Application\PresenterFactory', 'unformatPresenterClass', new UnionType([new StringType(), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\Responses\FileResponse', 'getContentType', new StringType()),
            new AddReturnTypeDeclaration('Nette\Application\Responses\ForwardResponse', 'getRequest', new ObjectType('Nette\Application\Request')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\IRouter', 'match', new UnionType([new ObjectType('Nette\Application\Request'), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\Routers\Route', 'getTargetPresenters', new UnionType([$arrayType, new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Component', 'getPresenter', new UnionType([new ObjectType('Nette\Application\UI\Presenter'), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Component', 'getReflection', new ObjectType('Nette\Application\UI\ComponentReflection')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Component', 'lazyLink', new ObjectType('Nette\Application\UI\Link')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Component', 'offsetGet', new ObjectType('Nette\ComponentModel\IComponent')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getRequest', new ObjectType('Nette\Application\Request')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getPresenter', new ObjectType('Nette\Application\UI\Presenter')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getSignal', new UnionType([$arrayType, new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'createTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getLastCreatedRequest', new UnionType([new ObjectType('Nette\Application\Request'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getLastCreatedRequestFlag', new BooleanType()),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getFlashSession', new ObjectType('Nette\Http\SessionSection')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getContext', new ObjectType('Nette\DI\Container')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getHttpRequest', new ObjectType('Nette\Http\IRequest')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getHttpResponse', new ObjectType('Nette\Http\IResponse')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getUser', new ObjectType('Nette\Security\User')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Presenter', 'getTemplateFactory', new ObjectType('Nette\Application\UI\ITemplateFactory')),
            new AddReturnTypeDeclaration('Nette\Application\Exception\BadRequestException', 'getHttpCode', new IntegerType()),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationDI\LatteExtension', 'addMacro', new VoidType()),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationDI\PresenterFactoryCallback', '__invoke', new ObjectType('Nette\Application\IPresenter')),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationLatte\ILatteFactory', 'create', new ObjectType('Latte\Engine')),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationLatte\Template', 'getLatte', new ObjectType('Latte\Engine')),
            ...
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationLatte\TemplateFactory', 'createTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationLatte\UIMacros', 'initialize', new VoidType()),
            new AddReturnTypeDeclaration('Nette\Bridges\ApplicationTracy\RoutingPanel', 'initializePanel', new VoidType()),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'getPersistentComponents', $arrayType),
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'hasCallableMethod', new BooleanType()),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'parseAnnotation', new UnionType([$arrayType, new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'getParameterType', $arrayType),
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'hasAnnotation', new BooleanType()),
            new AddReturnTypeDeclaration('Nette\Application\UI\ComponentReflection', 'getMethods', $arrayType),
            new AddReturnTypeDeclaration('Nette\Application\UI\Control', 'getTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            new AddReturnTypeDeclaration('Nette\Application\UI\Control', 'createTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\Form', 'getPresenter', new UnionType([new ObjectType('Nette\Application\UI\Presenter'), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\UI\ITemplateFactory', 'createTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            ...
            new AddReturnTypeDeclaration('Nette\Application\Routers\SimpleRouter', 'match', new UnionType([new ObjectType('Nette\Application\Request'), new NullType()])),
            ...
            new AddReturnTypeDeclaration('Nette\Application\MicroPresenter', 'getContext', new UnionType([new ObjectType('Nette\DI\Container'), new NullType()])),
            new AddReturnTypeDeclaration('Nette\Application\MicroPresenter', 'createTemplate', new ObjectType('Nette\Application\UI\ITemplate')),
            new AddReturnTypeDeclaration('Nette\Application\MicroPresenter', 'redirectUrl', new ObjectType('Nette\Application\Responses\RedirectResponse')),
            new AddReturnTypeDeclaration('Nette\Application\MicroPresenter', 'error', new VoidType()),
            new AddReturnTypeDeclaration('Nette\Application\MicroPresenter', 'getRequest', new UnionType([new ObjectType('Nette\Application\Request'), new NullType()])),
        ]),
    ]]);
};
