...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(ArgumentAdderRector::class)->call('configure', [[
        ArgumentAdderRector::ADDED_ARGUMENTS => ValueObjectInliner::inline([
            ...
            new ArgumentAdder('Symfony\Component\DependencyInjection\ContainerBuilder', 'addCompilerPass', 2, 'priority', 0),
            new ArgumentAdder('Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraph', 'connect', 6, 'weak', false),
        ]),
    ]]);
