...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(CallableInMethodCallToVariableRector::class)->call('configure', [[
    ...
    $services->set(AddParamTypeDeclarationRector::class)->call('configure', [[
        AddParamTypeDeclarationRector::PARAMETER_TYPEHINTS => ValueObjectInliner::inline([
            new AddParamTypeDeclaration('Nette\Application\UI\Presenter', 'sendTemplate', 0, new UnionType([new ObjectType('Nette\Application\UI\Template'), new NullType()])),
        ]),
    ]]);
